...
class VideoSwinTransformerBackbone(nn.Module):
    """
    A wrapper which allows using Video-Swin Transformer as a temporal encoder for FPRFormer.
    ...
    Additionally, we slightly modify video-swin to make it output per-frame embeddings as required by FPRFormer (check our
